...
|**[!INCLUDE[ssRS](../../includes/ssrs.md)]:**<br /><br /> (All rights are granted to the per-service SID. Default instance: **NT SERVICE\ReportServer**. Named instance: **NT SERVICE\\ReportServer$**_InstanceName_.)|**Log on as a service** (SeServiceLogonRight)<br /><br />  **Allow Log on locally** (SeInteractiveLogonRight)|  
...
|**R Services:** **SQLRUserGroup** (SQL 2016 and 2017)  |**Allow Log on locally** (SeInteractiveLogonRight)|   
